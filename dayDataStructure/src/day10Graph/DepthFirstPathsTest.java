...
public class DepthFirstPathsTest {
    public static void main(String[] args) throws Exception{
        ...
        BufferedReader br = new BufferedReader(new FileReader("G:\\IDEAProjects\\EmployeeTest\\dayDataStructure\\road_find.txt"));
...
//        BreadthFirstSearch paths = new BreadthFirstSearch(G, 0);
